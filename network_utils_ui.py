...
#
# Created: Sat Apr 18 19:26:03 2015
...
class Ui_networkutils(object):
    def setupUi(self, networkutils):
        ...
        self.visualTraceRouteWidget = QtGui.QWidget(self.traceroute)
        self.visualTraceRouteWidget.setGeometry(QtCore.QRect(-1, -1, 751, 451))
